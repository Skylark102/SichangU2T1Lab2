...
public class RectangleRunner {
    public static void main(String[] args) {
        ...
        System.out.println("Rectangle 1 has an area of " + rect1Area + " and a volume of " + rect1Volume);
        ...
        System.out.println("Rectangle 2 has an area of " + rect2area + " and a volume of " + rect2volume);
